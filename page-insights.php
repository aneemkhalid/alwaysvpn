<?php
/**
 * Template Name: Insights Aggregate Page
 *
 * @package WordPress
 * @subpackage Coinflip_Child
 * @since Coinflip Child 1.0
 * 
 * The template for displaying the insights aggregate page.
 *
 */
...
$filters_obj = get_field_object('field_60f5cc4abb7d5');
...
?>
    ...
    <!-- Page content -->
    <div id="primary" class="content-area no-sidebar resources-aggregate-page insights-page">
        <div class="container aggregate-page-container">
            <div class="row aggregate-row">
                    ...
                    <div class="flexible-content-container">
                        ...
                        <div class="flexible-content-blocks-container">
                            <?php foreach($flexible_page_tiles['content_blocks'] as $key => $content_block):
                                ...
                                if (get_field('insights_filters', $page_obj->ID)) {
                                    $filter_tags = get_field('insights_filters', $page_obj->ID);
                ...
                <div class="filter-wrapper" data-filters='<?php echo $filters_json;?>'>
                    <ul>
                        <li class="filter-all active"><a href="/insights">All</a></li>
                        <?php
                        foreach ($filters as $key => $filter){
                            ?>
                            <li class="filter-<?php echo $key; ?>"><a href="/insights#<?php echo $key; ?>"><?php echo $filter; ?></a></li>
                            <?php
                        }
                        ?>
                    </ul> 
